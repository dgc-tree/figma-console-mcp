...
<table>
<tr>
<td valign="top"><strong>Info panel</strong><br><img src="./screenshots/v0-2-1/info-panel-light.png" width="240" alt="Info panel showing current file and page"></td>
<td valign="top"><strong>Log panel</strong><br><img src="./screenshots/v0-2-1/log-panel-light.png" width="240" alt="Log panel with intent labels, Code prefix, and [!] errors"></td>
<td valign="top"><strong>Errors filter</strong><br><img src="./screenshots/v0-2-1/log-errors-filter-light.png" width="240" alt="Errors-only filter active"></td>
<td valign="top"><strong>Copy to clipboard</strong><br><img src="./screenshots/v0-2-1/log-copy-success-light.png" width="240" alt="Log copied to clipboard"></td>
</tr>
</table>
